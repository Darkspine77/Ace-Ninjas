class Shuriken extends Projectile {
  Shuriken(boolean damaging1, boolean lengthLimit1, int length1, float xsize1, float ysize1, float x1, float y1, float xvel1, float yvel1, statProfile stats1, Unit maker1) {
    x = x1;
    y = y1;
    xsize = xsize1;
    ysize = ysize1;
    ...
    frames1.put("idle", 2);
    loadAnimation(this, "Shuriken", selectFrames(frames1));
  }
